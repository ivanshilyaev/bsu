...
// 1. Определить строки файла, содержащие максимальную по длине
// подстроку, состоящую из одинаковых символов латинского алфавита.
// Заглавные и строчные буквы не различаются. Если таких строк несколько,
// найти первые 10.
